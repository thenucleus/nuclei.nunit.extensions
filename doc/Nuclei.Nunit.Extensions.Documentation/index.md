...
The `Nuclei.Nunit.Extensions` assembly contains a set of base classes for testing hashcode and equality contract implementations with NUnit.
...
This will build the binaries, the documentation and the NuGet package. The  NuGet package will be placed in the `build\deploy` directory.
